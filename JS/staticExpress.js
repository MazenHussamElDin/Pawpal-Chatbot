...
app.post('/register', async (req, res) => {
  ...
  if (!username || !email || !password || !ownerType || !dogSize || !dogBreed) {
    console.warn("Missing fields during registration");  // 👈 Log this too
  ...
  try {
    ...
    if (existingUser) {
      console.warn("Email already registered:", email);  // 👈 Log
    ...
    console.error('Registrierungsfehler:', err);  // 👈 This should now definitely show

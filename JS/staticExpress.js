...
app.post('/register', async (req, res) => {
  ...
  console.log("REGISTER REQ:", req.body);  // DEBUG
...
app.post('/login', async (req, res) => {
  ...
  try {
    ...
    console.log('pass is : ', password, 'actual is: ', user.password)
    ...
    switch (data.type) {
      case 'join':
        ...
        try {
          ...
          if (user) {
            ...
            if (history.length > 0) {
              ...
              ws.send(JSON.stringify({
                type: 'msg',
                name: 'PawPal',
                msg: "Ich habe deine letzte Unterhaltung geladen 🐾"
              }));
          ...
          console.error('Fehler beim Laden der Benutzerdaten oder Verlauf:', err);
        }
        break;
